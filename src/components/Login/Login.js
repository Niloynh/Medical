                ...
                <form className="full-form" onSubmit={handleReload}>
                    <div className="input-level">
                        ...
                        <label className="form-check-label mx-3 fw-bold fs-5"  for="exampleCheck1">Already Sign <span className="sign-up">Up</span> ?</label>
                         ...
                         <br />
                        <button className="login-btn mb-3" id="liveAlertBtn">Sign {isLogin ? "In" : "Up"}</button>
                </form> 

                <div><span className="fw-bold">----------------or----------------</span></div>

                    <button onClick={handleSignIn} className="google-btn mt-3"><img  className="google-icon" src={logo} alt="" /> Google</button>
            </div>
        </div>
    );
};
